...
FrontendApplicationConfigProvider.set({
    "applicationName": "ResearchAssistant",
    "defaultTheme": {
        "light": "Default Dark Modern",
...
module.exports = (async () => {
    ...
    try {
        ...
        await load(container, require('@research-assistant/theia-extension/lib/browser/research-assistant-frontend-module'));
