...
module.exports = async (port, host, argv) => {
    try {
        ...
        await load(require('@research-assistant/theia-extension/lib/node/research-assistant-backend-module'));
        ...
        await load(require('@theia/ai-mcp/lib/electron-node/mcp-electron-node-module'));
        ...
        await load(require('@theia/toolbar/lib/node/toolbar-backend-module'));
